...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Lead', path: '/leads', entity: 'lead', service: AccessServiceEnum.PROJECT, icon: FiUserCheck },
    { name: 'Order', path: '/orders', entity: 'order', service: AccessServiceEnum.PROJECT, icon: FiShoppingCart },
    { name: 'Product', path: '/products', entity: 'product', service: AccessServiceEnum.PROJECT, icon: FiPackage },
    { name: 'Quote', path: '/quotes', entity: 'quote', service: AccessServiceEnum.PROJECT, icon: FiDollarSign },
